...
def downgrade() -> None:
    for table in ["task_execution_history", "file_import_rows", "file_import_batches", "audit_logs", "income_events", "performance_snapshots", "margin_metrics", "risk_metrics", "greeks_snapshots", "trades", "positions", "option_contracts", "strategies", "broker_accounts", "instruments", "user_roles", "roles", "users"]:
        op.drop_table(table)
